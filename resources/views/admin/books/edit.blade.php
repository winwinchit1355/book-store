    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="py-3 py-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="page-title mb-0">Edit Book</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('books.update',$book->idx) }}"
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="row">
                                                ...
                                                <div class="form-select my-2">
                                                    ...
                                                    <select class="form-control @error('publisher_id') is-invalid @enderror " name="publisher_id" required>
                                                        ...
                                                        @foreach($publishers as $publisher)
                                                            <option value="{{$publisher->idx}}" @if(old('publisher_id',$book->publisher_id) == $publisher->idx) selected @endif>{{$publisher->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('publisher_id')
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="form-select my-2">
                                                    ...
                                                    <select class="form-control @error('co_id') is-invalid @enderror" name="co_id" required>
                                                        ...
                                                        @foreach($content_owners as $co)
                                                            <option value="{{$co->idx}}" @if(old('co_id',$book->co_id) == $co->idx) selected @endif>{{$co->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('co_id')
                                                        <div class="invalid-feedback">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                ...
                                                <div class="mb-3">
                                                    @if (isset($book->cover_photo) && Storage::disk('public')->exists($book->cover_photo))
                                                        <img id="frame" height="250px"
                                                            src="{{ asset('storage/' . $book->cover_photo) }}"
                                                            class="" />
                                                    @else
                                                        <img id="frame" height="250px" class=""
                                                            src="{{ asset('admin/images/no-image.png') }}" alt="">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
